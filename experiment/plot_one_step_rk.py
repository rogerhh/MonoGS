...
if __name__ == "__main__":
    ...
    for block_size in block_sizes:
        filename = f"experiment/data/frame{frame:06d}_rk_inner_losses_block-size-{block_size}.npy"
    ...
    plt.tight_layout()
    plt.savefig(f"experiment/data/frame{frame:06d}_rk_inner_losses.pdf")
    print(f"Saved inner losses and errors plot to experiment/data/frame{frame:06d}_rk_inner_losses_block-size-{block_size}.pdf")
