...
def solve_block_REK(A, b, block_size=10, max_iters=50, x_true=None):
    m, n = A.shape
...
if __name__ == "__main__":
    ...
    if True:
        ...
        for tracking_itr in range(20):
            ...
            max_rek_iters = 1000
            block_size = 2
            x, inner_losses, inner_errors = solve_block_REK(J, -f, x_true=x_true, block_size=block_size, max_iters=max_rek_iters)
        ...
        print(f"Saving outer losses to experiment/data/frame{args.frame:06d}_outer_losses_rek_block-size-{block_size}.npy")
        np.save(f"experiment/data/frame{args.frame:06d}_outer_losses_rek_block-size-{block_size}.npy", outer_losses)
