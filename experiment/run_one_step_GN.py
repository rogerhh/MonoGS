...
if __name__ == "__main__":
    ...
    if True:
        ...
        print(f"Saving outer losses to experiment/data/frame{args.frame:06d}_outer_losses_GN.npy")
        np.save(f"experiment/data/frame{args.frame:06d}_outer_losses_GN.npy", outer_losses)
